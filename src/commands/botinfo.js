...
module.exports.run = async (client,message,args) => {
   if(!args[0]) return message.channel.send(
     new MessageEmbed()
     .setDescription(`${emoji.error} Please provide a correct ID.`)
     .setColor(`2f3136`)
   )
   ...
   .setDescription("**[Vote for the bot named "+b.username+"#"+b.discrim+" in DTL.](https://townlist.xyz/bot/"+b.botID+"/vote)**")
