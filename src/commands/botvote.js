...
module.exports.run = async (client, message, args) => {
  ...
  var seconds = timeleft.seconds;
    ...
    client.channels.cache.get("891226286587015219").send(`**${botdata.username}** just got **+1 Vote** from **${message.author.username}** **\`(Total Votes ${botdata.votes + 1})\`**`)
    let web = new MessageButton()
      .setLabel("Visit bot page")
      .setStyle("url")
      .setURL("https://townlist.xyzbot/"+botdata.botID)
  ...
  let web = new MessageButton()
    .setLabel("Visit bot page")
    .setStyle("url")
    .setURL("https://townlist.xyz/bot/"+botdata.botID)
  const vote = new Discord.MessageEmbed()
	.setTitle("Voted")
	.setColor("2f3136")
	.setAuthor(message.author.username, message.author.avatarURL({ dynamic: true }))
  ...
  if (botdata.dcwebhook) {
    ...
    const msg = new webhook.MessageBuilder()
      .setName("DTL Bot List Discord Webhooks")
