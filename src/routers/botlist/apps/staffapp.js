...
app.get("/staffapp", global.checkAuth, async (req, res) => {
    ...
    let botdata = await botsdata.findOne({
	    ...
	    res.render("botlist/apps/staffapp.ejs", {
	        bot: global.Client,
	        path: req.path,
...
app.post("/staffapp", global.checkAuth, async (req, res) => {
    ...
    res.redirect("/bots?success=true&message=You have already applied.")
